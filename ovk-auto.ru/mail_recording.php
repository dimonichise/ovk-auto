...
MAIL_FROM = 'dmitriy-bochkov@mail.ru', // от какого email будет отправляться письмо
MAIL_FROM_NAME = 'OVK-AUTO', // от какого имени будет отправляться письмо
MAIL_SUBJECT = 'Сообщение с формы обратной связи', // тема письма
MAIL_ADDRESS = 'dvbochkov@ovk-auto.ru', // кому необходимо отправить письмо
...
MAIL_SMTP_USERNAME = 'dmitriy-bochkov@mail.ru', // SMTP-пользователь
MAIL_SMTP_PASSWORD = 'a5770s1086'; // SMTP-пароль
