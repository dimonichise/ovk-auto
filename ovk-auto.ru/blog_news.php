        ...
        <div class="row">
            <div class="col-lg-8 mb-5 mb-lg-0">
                <div class="blog_left_sidebar">
                    ...
                    $total=$db->query("SELECT COUNT(*) as count FROM news  WHERE `category_id` = 1")->fetchColumn();
                  ...
                  <nav class="blog-pagination justify-content-center d-flex">
                        ...
                        <!-- Стрелка назад --> 
                            <li class="page-item">
                                <a href="blog_news.php?page=<?php if($page!=1) {
                                    echo $page-1;
                                } else{
                                    echo $page=1;
                                }
                    ...
                    <?php for ($i = 1; $i <= $str_pag; $i++){
                        ...
                        <a href=blog_news.php?page='.$i.' class="page-link">'.$i.'</a>
                    </li>';
                        else {
                       ...
                       <!--Стрелка назад -->   
                            <li class="page-item">
                            <a href="blog_news.php?page=<?php if($page<$str_pag) {
                                echo $page+1;
                            }else {
                                echo $page;
                            }
